...
<style>
    .whitebox-section{background-color:#eeebf9; width: 97%; margin-top: 7px; border-radius: 5px; height: 100%;}
                ...
                @csrf
                    ...
                    <div class="row" style="margin-top:5px;">
                        ...
                        <div class="col" style="color:black;">
                            ...
                            <div class="col-3 form-check form-check-inline">
                              <input class="form-check-input" name="genero[]" type="checkbox" value="Jogos">
                              <label class="form-check-label" for="inlineCheckbox2">Jogos</label>
                            </div>
                            <div class="col-3 form-check form-check-inline">
                              <input class="form-check-input" name="genero[]" type="checkbox" value="Luta">
